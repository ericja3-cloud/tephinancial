...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-COpKmXKw.mjs");
...
const manifest = {
  "20f92152bfa788f58b12276be000fafca05df61c5056af58fa5ccb5dbf7ffc5e": {
    functionName: "extractReceipt_createServerFn_handler",
    importer: () => import("./receipts.functions-_X5451-U.mjs")
  },
  "c0628bb655a1a608f1fa5c240379111ce31c5729dca356f332f8317b33978c7f": {
    functionName: "askPocketManager_createServerFn_handler",
    importer: () => import("./chat.functions-DKKeE_Wv.mjs")
  },
  "f5cf2d5865f7acbfd61b8d94f6780c76d22fec877008ff079eae1d7ff6c83171": {
    functionName: "sendWhatsAppNotification_createServerFn_handler",
    importer: () => import("./whatsapp.functions-CgV7cHP5.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-f3VAqw2h.mjs").then((n) => n.r),
    import("./start-BDnpl54H.mjs"),
