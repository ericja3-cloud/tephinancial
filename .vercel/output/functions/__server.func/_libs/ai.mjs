...
import { h as withUserAgentSuffix, x as filterNullable, y as asArray, e as safeValidateTypes, A as createIdGenerator, B as retryWithExponentialBackoff, C as isExecutableTool, D as asSchema, E as safeParseJSON, F as executeTool, G as isUrlSupported, f as convertUint8ArrayToBase64, t as convertBase64ToUint8Array, H as validateTypes, I as isProviderReference, J as isFullMediaType, K as detectMediaType, L as getRuntimeEnvironmentUserAgent, M as fetchWithValidatedRedirects, N as cancelResponseBody, O as DownloadError, P as readResponseWithSizeLimit, Q as DEFAULT_MAX_DOWNLOAD_SIZE, R as isBuffer, r as resolve } from "./ai-sdk__provider-utils.mjs";
import { a as AISDKError, b as InvalidPromptError, g as getErrorMessage, A as APICallError, T as TypeValidationError } from "./ai-sdk__provider.mjs";
import { b as array$1, g as lazy, r as record, a as string, c as union, h as _instanceof, i as custom, o as object$1, l as literal, d as discriminatedUnion, f as boolean, u as unknown, j as _null, n as number } from "./zod.mjs";
...
var taggedFileDataSchema = discriminatedUnion("type", [
  object$1({ type: literal("data"), data: fileInlineDataSchema }),
  object$1({ type: literal("url"), url: _instanceof(URL) }),
  object$1({
...
var taggedReasoningFileDataSchema = discriminatedUnion("type", [
  object$1({ type: literal("data"), data: fileInlineDataSchema }),
  object$1({ type: literal("url"), url: _instanceof(URL) })
]);
